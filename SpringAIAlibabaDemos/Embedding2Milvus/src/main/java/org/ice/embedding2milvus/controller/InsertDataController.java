...
public class InsertDataController {
    ...
    /*
        http://localhost:8086/insertData
     */
    ...
    public void getCollection() {
        ...
        // 向 collection 插入数据
        insertDataIntoCollection(milvus, "testCollection");
    }

    private void insertDataIntoCollection(MilvusClientV2 milvus, String collectionName) {
        Gson gson = new Gson();
        ...
        // 插入数据
        InsertResp insert = milvus.insert(InsertReq.builder().collectionName(collectionName).data(data).build());
        // 刷新数据
        milvus.flush(FlushReq.builder().collectionNames(List.of(collectionName)).build());
